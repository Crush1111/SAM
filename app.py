...
def seg_track_app():
    ...
    ##########################################################
        ...
        """with gr.Tab(label='Image-seq expamle'):
            gr.Examples(
                examples=[
                    os.path.join(os.path.dirname(__file__), "dataset/zhuanhuanyuan_seg", "4.zip"),
                    os.path.join(os.path.dirname(__file__), "dataset/zhuanhuanyuan_seg", "3.zip"),
                    os.path.join(os.path.dirname(__file__), "dataset/zhuanhuanyuan_seg", "2.zip"),
                    os.path.join(os.path.dirname(__file__), "dataset/zhuanhuanyuan_seg", "1.zip"),
                ],
                inputs=[input_img_seq],
            )"""
        folder_path = os.path.join(os.path.dirname(__file__), "dataset/zhuanhuanyuan_seg")
        zip_files = [file_name for file_name in os.listdir(folder_path) if file_name.endswith(".zip")]

        examples = []
        for zip_file in zip_files:
            zip_path = os.path.join(folder_path, zip_file)
            examples.append(zip_path)
    ...
    convert_masks(input_first_frame,input_first_frame)
